<?php include 'layouts/header.php'; ?>
        ...
        <!-- Table css -->
        <link href="public/assets/plugins/RWD-Table-Patterns/dist/css/rwd-table.min.css" rel="stylesheet" type="text/css" media="screen">
...
<?php include 'layouts/headerStyle.php'; ?>
    ...
    <body>
        ...
        <!-- Responsive-table-->
        <script src="public/assets/plugins/RWD-Table-Patterns/dist/js/rwd-table.min.js" type="text/javascript"></script>
