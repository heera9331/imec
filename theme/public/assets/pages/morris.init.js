...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b', 'c'], ['Activated', 'Pending', 'Deactivated'], ['#5468da', '#ffbb44', '#67a8e4']);
            ...
            this.createDonutChart('morris-donut-example', $donutData, ['#ea553d', '#707070', '#afb42b']);
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#009688', '#4ac18e']);
