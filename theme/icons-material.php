                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Material Design Icon</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Material Design Icon</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Use <code>&lt;i class="mdi
