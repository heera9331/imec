<?php include 'layouts/header.php'; ?>
        ...
        <!-- X-editable css -->
        <link type="text/css" href="public/assets/plugins/x-editable/css/bootstrap-editable.css" rel="stylesheet">
...
<?php include 'layouts/headerStyle.php'; ?>
    ...
    <body>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">This library allows you to create
        ...
        <script type="text/javascript" src="public/assets/plugins/x-editable/js/bootstrap-editable.min.js"></script>
        <script type="text/javascript" src="public/assets/pages/xeditable.js"></script>
